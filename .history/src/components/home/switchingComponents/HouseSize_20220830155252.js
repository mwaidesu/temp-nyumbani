...
import HouseSize from '../../../../.history/src/components/home/switchingComponents/HouseSize_20220830093605';

const hSize = ({formData, setFormData}) => {
  return (
    <div>
...
<div className="mb-6">
<label for="houseSize" class="block mb-2 text-sm font-medium text-white dark:text-gray-400">House Size</label>
