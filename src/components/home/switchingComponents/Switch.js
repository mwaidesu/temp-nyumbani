...
const Switch = () => {
  ...
  const notify = () => toast(`Your moving date is ${formData.date} at ${formData.time} from your ${formData.houseSize} apartment.  ${formData.mover} has been notified to transport your belongings from ${formData.origin} to ${formData.destination}. Your total cost will be ${formData.total}` );
  return (
