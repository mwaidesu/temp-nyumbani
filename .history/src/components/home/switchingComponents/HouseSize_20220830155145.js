...
const Size = ({formData, setFormData}) => {
  return (
    <div>
...
<div className="mb-6">
<label for="" class="block mb-2 text-sm font-medium text-white dark:text-gray-400"> Size</label>
<select id="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value={formData.} onChange={(e) => setFormData({...formData, : e.target.value})}>
